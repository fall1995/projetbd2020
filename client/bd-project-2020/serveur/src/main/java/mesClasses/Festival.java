...
public class Festival {
	...
	public Festival(String idFestival, String nomFestival, String domaine, String complementDomaine, String region,
			...
			Date dateFin, Date dateCreation, int codepost, String codeINSEE, String coordonneesINSEE,
		...
		this.coordonneesINSEE = coordonneesINSEE;
	...
	public String getCoordonneesINSEE() {
		return coordonneesINSEE;
	}
	public void setCoordonneesINSEE(String coordonneesINSEE) {
		this.coordonneesINSEE = coordonneesINSEE;
	}
